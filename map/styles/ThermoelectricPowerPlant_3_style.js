var size = 0;
var placement = 'point';
function categories_ThermoelectricPowerPlant_3(feature, value, size, resolution, labelText,
...
var style_ThermoelectricPowerPlant_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("PrimSource");
        if ("" !== null) {
            labelText = String("");
        }
    ...
    var style = categories_ThermoelectricPowerPlant_3(feature, value, size, resolution, labelText,
